...
from tga_models.ta.abstractions import *
from tga_models.ta.pyuppaal import *
from tga_models.ta.timedautomata import *
...
class Network(TGA):
    ...
    def __init__(self, channels, delta, index=shortuuid.uuid()[:6],
